    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <div ref={headerRef} className={`fixed top-0 left-0 right-0 z-50 transition-transform duration-300 ${showHeader ? 'translate-y-0' : '-translate-y-full'}`}>
        <div className="w-full flex items-center justify-between px-4 md:px-6 py-4 bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60 animate-fade-in">
          ...
          <nav className="hidden sm:flex items-center gap-6">
            ...
            <a href="/personal-webs/scresume.pdf" target="_blank" rel="noopener noreferrer" className="text-sm text-accent border border-accent/60 hover:border-accent px-4 py-2 rounded-md transform transition-transform duration-200 hover:-translate-y-0.5 hover:shadow-[0_8px_20px_rgba(0,230,184,0.25)]">
              Resume
            </a>
          </nav>
        </div>
      ...
      <section id="hero" className="min-h-screen flex items-center px-4 md:px-6 pt-20 pb-16">
        <div className="mx-auto max-w-3xl w-full">
          ...
          <a href="/personal-webs/scresume.pdf" target="_blank" rel="noopener noreferrer" className="inline-flex items-center mt-8 text-accent border border-accent/60 hover:border-accent px-5 py-3 rounded-md animate-fade-in transform transition-transform duration-200 hover:-translate-y-0.5 hover:shadow-[0_12px_24px_rgba(0,230,184,0.25)]" style={{animationDelay:'500ms'}}>
            Check out my resume!
            </a>
          </div>
        </section>
